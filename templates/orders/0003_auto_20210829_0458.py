# Generated by Django 3.2.4 on 2021-08-29 04:58
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='customer_orders', to='orders.customer', verbose_name='покупатель')),
            ],
        ),
        migrations.AddField(
            model_name='customer',
            name='orders',
            field=models.ManyToManyField(related_name='order_customers', to='orders.Order', verbose_name='заказы покупателя'),
        ),
    ]
